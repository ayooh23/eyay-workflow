...
export const GATES: DecisionGate[] = [
  // DISCOVER → DEFINE
  {
    phaseId: 'idea', serviceId: 'site', title: 'Ready for Define?', nextPhase: 'prd',
    items: [
  ...
  {
    phaseId: 'idea', serviceId: 'tool', title: 'Ready for Define?', nextPhase: 'prd',
    items: [
  ...
  {
    phaseId: 'idea', serviceId: 'mvp', title: 'Ready for Define?', nextPhase: 'prd',
    items: [
  ...
  {
    phaseId: 'idea', serviceId: 'ai', title: 'Ready for Define?', nextPhase: 'prd',
    items: [
  ...
  // DEFINE → BUILD
  {
    phaseId: 'prd', serviceId: 'site', title: 'Ready for Build?', nextPhase: 'build',
    items: [
      ...
      { id: 'timeline', text: 'Animated components flagged (they take 3× longer)' },
    ],
  },
  {
    phaseId: 'prd', serviceId: 'tool', title: 'Ready for Build?', nextPhase: 'build',
    items: [
  ...
  {
    phaseId: 'prd', serviceId: 'mvp', title: 'Ready for Build?', nextPhase: 'build',
    items: [
  ...
  {
    phaseId: 'prd', serviceId: 'ai', title: 'Ready for Build?', nextPhase: 'build',
    items: [
  ...
  // BUILD → VALIDATE
  {
    phaseId: 'build', serviceId: 'site', title: 'Ready for Validate?', nextPhase: 'qa',
    items: [
  ...
  {
    phaseId: 'build', serviceId: 'tool', title: 'Ready for Validate?', nextPhase: 'qa',
    items: [
  ...
  {
    phaseId: 'build', serviceId: 'mvp', title: 'Ready for Validate?', nextPhase: 'qa',
    items: [
  ...
  {
    phaseId: 'build', serviceId: 'ai', title: 'Ready for Validate?', nextPhase: 'qa',
    items: [
  ...
  // VALIDATE → SHIP
  {
    phaseId: 'qa', serviceId: 'site', title: 'Ready to Ship?', nextPhase: 'close',
    items: [
  ...
  {
    phaseId: 'qa', serviceId: 'tool', title: 'Ready to Ship?', nextPhase: 'close',
    items: [
  ...
  {
    phaseId: 'qa', serviceId: 'mvp', title: 'Ready to Ship?', nextPhase: 'close',
    items: [
  ...
  {
    phaseId: 'qa', serviceId: 'ai', title: 'Ready to Ship?', nextPhase: 'close',
    items: [
  ...
  // SHIP (final)
  {
    phaseId: 'close', serviceId: 'site', title: 'Project Complete?', nextPhase: '',
    items: [
  ...
  {
    phaseId: 'close', serviceId: 'tool', title: 'Project Complete?', nextPhase: '',
    items: [
  ...
  {
    phaseId: 'close', serviceId: 'mvp', title: 'Project Complete?', nextPhase: '',
    items: [
  ...
  {
    phaseId: 'close', serviceId: 'ai', title: 'Project Complete?', nextPhase: '',
    items: [
